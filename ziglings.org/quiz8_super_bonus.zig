...
pub fn main() void {
    ...
    inline for (letters) |letter| {
        // I guess this means that everything is one big scope, and the
        // definitions at the top-level of this file are another "container"
        // (as the docs refer to it as?) that @This() is referencing when it's
        // called within a function that's inside this file-level scope.
